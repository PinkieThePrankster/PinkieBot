...
def seen(phenny, input):
    ...
    elif inputnick == 'my butt':
        phenny.say("While I am sure you have a nice butt, I have not seen it")
    elif inputnick == 'your butt':
        phenny.say ("\x01ACTION wiggles her butt for " + input.nick + ". It is a nice butt, isn't it?" + "\x01")
